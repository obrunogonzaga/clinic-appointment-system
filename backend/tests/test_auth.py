...
class TestAuthService:
    ...
    @pytest.mark.asyncio
    async def test_check_first_admin_setup_needed(
    ...
    @pytest.mark.asyncio
    async def test_check_first_admin_setup_not_needed(
        self, auth_service, mock_user_repository
    ):
    ...
    async def test_register_first_admin_success(
        self, auth_service, mock_user_repository, admin_user
    ):
    ...
    @pytest.mark.asyncio
    async def test_register_first_admin_already_exists(
        self, auth_service, mock_user_repository
    ):
