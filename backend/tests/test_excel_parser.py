...
class TestExcelParserService:
    ...
    def sample_excel_data(self):
        ...
        return {
            ...
            "Data/Hora Início Agendamento": ["15/01/2025 14:30", "16/01/2025 10:00", "17/01/2025 16:45"],
            "Status Agendamento": ["Confirmado", "Cancelado", "Agendado"],
            "Contato(s) do Paciente": ["11999887766", "(11) 9 8877-6655", "11 98765-4321"],
            "Observação": ["Primeira consulta", None, "Retorno"],
            "Nomes dos Exames": ["Clínico Geral", "Cardiologia", "Dermatologia"]
        }
    ...
    async def test_parse_valid_excel_file(self, parser_service: ExcelParserService, sample_excel_data):
    ...
    async def test_parse_excel_with_missing_columns(self, parser_service: ExcelParserService):
    ...
    async def test_parse_excel_with_invalid_data(self, parser_service: ExcelParserService):
        ...
        data = {
            ...
            "Data/Hora Início Agendamento": ["15/01/2025 14:30", "invalid_date"],  # Invalid date
    ...
    async def test_clean_string_method(self, parser_service: ExcelParserService):
        ...
        # Test normal string
        assert parser_service._clean_string("  Normal String  ") == "Normal String"
    ...
    async def test_clean_phone_method(self, parser_service: ExcelParserService):
        ...
        assert parser_service._clean_phone("+55 11 99988-7766") == "11999887766"
        assert parser_service._clean_phone("11 99988-7766") == "11999887766"
        
        # Test multiple phones (semicolon separated)
        assert parser_service._clean_phone("11999887766;11988776655") == "11999887766"
    ...
    async def test_map_status_method(self, parser_service: ExcelParserService):
        ...
        assert parser_service._map_status("Efetivado") == "Confirmado"  # Mapped
    ...
    async def test_get_file_info(self, parser_service: ExcelParserService, sample_excel_data):
    ...
    async def test_parse_csv_file(self, parser_service: ExcelParserService, sample_excel_data):
    ...
    async def test_parse_unsupported_file_format(self, parser_service: ExcelParserService):
    ...
    async def test_parse_file_with_different_datetime_formats(self, parser_service: ExcelParserService):
        ...
        data = {
            ...
            "Contato(s) do Paciente": ["11999887766", "11988776655", "11977665544"],
            "Observação": ["OK", "OK", "OK"],
            "Nomes dos Exames": ["Clínico Geral", "Cardiologia", "Dermatologia"]
        }
