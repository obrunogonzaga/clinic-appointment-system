...
class TestAppointmentRepository:
    ...
    async def test_create_appointment(self, repository: AppointmentRepository, sample_appointment: Appointment):
    ...
    async def test_find_by_id(self, repository: AppointmentRepository, sample_appointment: Appointment):
    ...
    async def test_find_by_filters(self, repository: AppointmentRepository):
        ...
        # Test filter by unit
        centro_appointments = await repository.find_by_filters(nome_unidade="UBS Centro")
        ...
        date_filtered = await repository.find_by_filters(
            data_inicio=datetime(2025, 1, 18),
            data_fim=datetime(2025, 1, 22)
        )
    ...
    async def test_update_appointment(self, repository: AppointmentRepository, sample_appointment: Appointment):
    ...
    async def test_delete_appointment(self, repository: AppointmentRepository, sample_appointment: Appointment):
