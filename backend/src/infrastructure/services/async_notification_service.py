...
class AsyncNotificationService:
    ...
    def __init__(
        self, settings: Settings, email_service: Optional[EmailService] = None
    ):
        """
    ...
    def send_welcome_email(
        ...
        context = {
            ...
            "approved_at": (
                user.approved_at.strftime("%d/%m/%Y %H:%M")
                if user.approved_at
                else ""
            ),
    ...
    def send_rejection_email(
        ...
        context = {
            ...
            "rejected_at": (
                user.rejected_at.strftime("%d/%m/%Y %H:%M")
                if user.rejected_at
                else ""
            ),
    ...
    def send_approval_confirmation(
        self, background_tasks: BackgroundTasks, user: UserEnhanced
    ):
        """
