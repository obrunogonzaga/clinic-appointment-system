...
class AppointmentRepository(AppointmentRepositoryInterface):
    ...
    async def update(self, appointment_id: str, update_data: Dict[str, any]) -> Optional[Appointment]:
        """
    ...
    async def create_indexes(self) -> None:
        ...
        try:
            ...
            indexes = [
                ...
                ([("nome_unidade", ASCENDING), ("nome_marca", ASCENDING)], "idx_unidade_marca"),
                ([("data_agendamento", ASCENDING), ("status", ASCENDING)], "idx_data_status"),
                ([("nome_unidade", ASCENDING), ("data_agendamento", ASCENDING)], "idx_unidade_data"),
            ]
